...
```{r avh, echo=FALSE, fig.cap="Comparison of Average annual hours worked by workers in Australia and Indonesia", fig.height= 4}
au_idn %>% 
  ggplot(aes(x = Year, 
             y = avh, 
             color = Country)) +
...
Furthermore, looking at the comparison table \@ref(tab:mean) here, we can see that on average from the year 1970 to 2017,  Australia has around 100 working hours less than Indonesia, but the GDP is 7 times higher compared  to Indonesia's GDP. Therefore we can conclude that between Australia and Indonesia there is an inverse correlation, where less Average working hours contributed to  higher GDP while more working hours resulted in a lower overall GDP.
